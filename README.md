...
We have aslo released our synthetic test dataset for an easiser comparison for future researches. For the quantitative statistics, please refer to the table 2 in this paper. Note also that this dataset is built based on the '[PU-GAN](https://liruihui.github.io/publication/PU-GAN/)'.
