...
def batch_mkdir(output_folder, subdir_list): #创建不存在的父文件夹和所有子文件夹
...
# Write numpy array data and label to h5_filename 将numpy数组数据和标签写入h5文件
...
# Read numpy array data and label from h5_filename 从h5_文件读取numpy数组数据和标签
